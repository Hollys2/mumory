...
public struct MumoryCommentSheetView: View {
    ...
    public init(isSheetShown: Binding<Bool>, offsetY: Binding<CGFloat>, mumoryAnnotation: MumoryAnnotation, comments: [Comment]) {
                            ...
                            HStack(spacing: 0) {
                                ...
                                .background(
                                    ZStack(alignment: .trailing) {
                                        ...
                                        Button(action: {
                                            mumoryDataViewModel.createComment(mumoryAnnotation: mumoryDataViewModel.selectedMumoryAnnotation ?? MumoryAnnotation(), loginUserID: "tester", comment: Comment(author: "tester", date: Date(), content: commentText, isPublic: true))
                                            commentText = ""
                                        }, label: {
