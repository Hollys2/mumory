...
public struct UpdateScrollViewWrapper<Content: View>: UIViewRepresentable {
    @Binding var contentOffset: CGPoint
    @Binding var scrollViewHeight: CGFloat
    @Binding var visibleHeight: CGFloat
    @Binding var songs: MusicItemCollection<Song>
    ...
    public init(
        ...
        songs: Binding<MusicItemCollection<Song>>,
    ...
    public func makeUIView(context: UIViewRepresentableContext<UpdateScrollViewWrapper>) -> UIScrollView {
    ...
    public func updateUIView(_ uiView: UIScrollView, context: UIViewRepresentableContext<UpdateScrollViewWrapper>) {
