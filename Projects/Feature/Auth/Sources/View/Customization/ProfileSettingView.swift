...
struct ProfileSettingView: View {
    ...
    private func getNicknameError(nickname: String){
        print("nickname: \(customizationObject.nickname), id: \(customizationObject.id)")
        
        if nickname.count > 0 && nickname.count < 3 {
            nicknameErrorString = "2자 이상 입력해주세요"
            customizationObject.nickname = ""
        }else{
            ...
            query.getDocuments { snapshot, error in
                if let error = error {
                    ...
                    if dataCount > 0 {
                        ...
                        nicknameErrorString = ""
                        customizationObject.nickname = nickname
            ...
            query.getDocuments { snapshot, error in
                if let error = error {
                    ...
                    if dataCount > 0 {
                        ...
                        customizationObject.id = ""
                    }else{
                        idErrorString = ""
                        customizationObject.id = id
                    }
                }else {
                    print("snapshot error")
                }
