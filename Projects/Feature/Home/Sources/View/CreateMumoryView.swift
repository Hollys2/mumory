...
//    @State private var testViewShown = false
//
...
//                    NavigationLink(
//                        destination: SearchLocationView(translation: <#Binding<CGSize>#>),
//                        isActive: $appCoordinator.isSearchLocationViewShown
//                    ) {
//                        HStack(spacing: 16) {
...
//            }
//
////            TestView(isShown: $testViewShown)
////                .offset(x: testViewShown ? 0 : UIScreen.main.bounds.width)
////                .animation(.easeInOut(duration: 0.5), value: testViewShown)
//            //                            .gesture(
//            //                                DragGesture()
