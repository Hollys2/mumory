                    ...
                    if let choosedMusicModel = mumoryDataViewModel.choosedMusicModel,
                       let choosedLocationModel = mumoryDataViewModel.choosedLocationModel {
                        ...
                        dispatchGroup.notify(queue: .main) {
                            ...
                            let newMumoryAnnotation = Mumory(id: "", uId: currentUserData.user.uId, date: self.calendarDate, songModel: choosedMusicModel, locationModel: choosedLocationModel, tags: self.tags, content: self.contentText, imageURLs: self.imageURLs, isPublic: self.isPublic, likes: [], commentCount: 0, myCommentCount: 0)
