...
public enum LibraryColorSet {
    public static let background = Color(red: 0.09, green: 0.09, blue: 0.09)
    public static let purpleBackground = Color(red: 0.64, green: 0.51, blue: 0.99)
    public static let darkGrayBackground = Color(red: 0.16, green: 0.16, blue: 0.16)
